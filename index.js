...
// files returned by the bootstrap process and sets up an object that has
// each error type.  New files are automagically picked up and exported,
// and consumers can choose whether or not to use insulin.
